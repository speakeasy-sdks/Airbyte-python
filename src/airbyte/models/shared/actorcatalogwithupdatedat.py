...
class ActorCatalogWithUpdatedAt:
    ...
    catalog: Optional[ActorCatalogWithUpdatedAtCatalog] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('catalog'), 'exclude': lambda f: f is None }})
