...
class ConnectionState:
    ...
    state_type: shared_connectionstatetype.ConnectionStateType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('stateType') }})
    ...
    state: Optional[shared_stateblob.StateBlob] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})
