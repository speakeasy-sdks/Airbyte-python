...
import dataclasses
from ..shared import attemptfailureorigin as shared_attemptfailureorigin
from ..shared import attemptfailuretype as shared_attemptfailuretype
...
class AttemptFailureReason:
    ...
    failure_type: Optional[shared_attemptfailuretype.AttemptFailureType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('failureType'), 'exclude': lambda f: f is None }})
