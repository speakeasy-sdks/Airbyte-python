...
from ..shared import sourcedefinitionspecification as shared_sourcedefinitionspecification
...
class SourceDefinitionSpecificationRead:
    ...
    connection_specification: Optional[shared_sourcedefinitionspecification.SourceDefinitionSpecification] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('connectionSpecification'), 'exclude': lambda f: f is None }})
